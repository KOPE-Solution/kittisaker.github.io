    ...
    <footer className="w-full h-20 border-t lg:flex hidden px-6 absolute bottom-0">
      <div className="w-1/2 h-full flex items-center justify-start">
        <p className="text-sm text-slate-900">
          © 2023 {" "}
          {/* Powered by{" "} */}
          <Link href="/" target="_blank" className="font-semibold hover:underline">Samiti.dev</Link> {" "}
          All Rights Reserved.
      ...
      <div className="w-1/2 h-full flex items-center justify-end">
        ...
        <Link href="https://github.com/#" target="_blank" ><AiFillGithub className="text-2xl text-slate-500 ml-3" /></Link> 
      </div>
    </footer>
  );
}
